...
A binary heap is a complete binary tree. Heaps are usually implemented with arrays. If the root is at index 0, then :
\begin{center}
	parent($i$) = floor($\frac{n-1}{2}$) \hspace{0.7cm} left($i$) = $2i+1$ \hspace{0.7cm} right($i$) = $2i+2$
\end{center}
